...
---
## articles의 views.py 개선과 Home.html에 외부 API로 영화 정보를 가져와서 표시함
---
## HOME.html 최신 영화와 박스오피스 순위가 나오도록 수정했습니다.
---
## 로그인 토큰 문제 해결 및 로그아웃 해결 및 챗봇 페이지 수정 및 게시글 생성 페이지 생성 및 메인 페이지 로그인 시 헤더 바뀌게 함
---
## 게시글 상세 페이지, 게시글 수정 페이지 및 삭제, 댓글 수정 및 상세 페이지와 삭제 기능, 영화 상세 정보 페이지 구현
---
